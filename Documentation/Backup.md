<TaskerData sr="" dvi="1" tv="5.9.1">
	<Project sr="proj0" ve="2">
		<cdate>1579039415348</cdate>
		<name>Backup</name>
		<tids>63,75,74,76,60,61</tids>
	</Project>
	<Task sr="task60">
		<cdate>1578740068039</cdate>
		<edate>1579959910305</edate>
		<id>60</id>
		<nme>Backup.Settings.run</nme>
		<pri>100</pri>
		<Action sr="act0" ve="7">
			<code>20</code>
			<App sr="arg0">
...
Only available if you select &amp;lt;b&amp;gt;Continue Task After Error&amp;lt;/b&amp;gt; and the action ends in error&lt;/_array_net.dinglisch.android.tasker.RELEVANT_VARIABLES1&gt;&lt;/StringArray&gt;</net.dinglisch.android.tasker.RELEVANT_VARIABLES>
	...
	<Task sr="task61">
		<cdate>1579039552721</cdate>
		<edate>1579959901269</edate>
		<id>61</id>
		<nme>Backup.GoogleAccount.run</nme>
		<pri>100</pri>
		<Action sr="act0" ve="7">
			<code>20</code>
			<App sr="arg0">
...
Only available if you select &amp;lt;b&amp;gt;Continue Task After Error&amp;lt;/b&amp;gt; and the action ends in error&lt;/_array_net.dinglisch.android.tasker.RELEVANT_VARIABLES1&gt;&lt;/StringArray&gt;</net.dinglisch.android.tasker.RELEVANT_VARIABLES>
					...
					<net.dinglisch.android.tasker.subbundled>true</net.dinglisch.android.tasker.subbundled>
					<net.dinglisch.android.tasker.subbundled-type>java.lang.Boolean</net.dinglisch.android.tasker.subbundled-type>
					<plugininstanceid>4d77d641-eddd-49d9-b78a-4e26ab03963f</plugininstanceid>
					<plugininstanceid-type>java.lang.String</plugininstanceid-type>
					<plugintypeid>com.joaomgcd.autoinput.intent.IntentPerformAction</plugintypeid>
					<plugintypeid-type>java.lang.String</plugintypeid-type>
				</Vals>
	...
	<Task sr="task63">
		<cdate>1578740068039</cdate>
		<edate>1579959906138</edate>
		<id>63</id>
		<nme>Backup.Nova.run</nme>
		<pri>100</pri>
		<Action sr="act0" ve="7">
			<code>130</code>
			<Str sr="arg0" ve="3">Backup.Nova._launchSettingsOnFirstPage</Str>
			<Int sr="arg1">
				<var>%priority</var>
			</Int>
...
Only available if you select &amp;lt;b&amp;gt;Continue Task After Error&amp;lt;/b&amp;gt; and the action ends in error&lt;/_array_net.dinglisch.android.tasker.RELEVANT_VARIABLES1&gt;&lt;/StringArray&gt;</net.dinglisch.android.tasker.RELEVANT_VARIABLES>
		...
		<Action sr="act3" ve="7">
			...
			<Bundle sr="arg0">
				<Vals sr="val">
					<ActionId>com.teslacoilsw.launcher:id/backup</ActionId>
					<ActionId-type>java.lang.String</ActionId-type>
					<ActionType>16</ActionType>
					<ActionType-type>java.lang.String</ActionType-type>
					<EnableDisableAccessibilityService>&lt;null&gt;</EnableDisableAccessibilityService>
...
Value: com.teslacoilsw.launcher:id/backup
Action : Click
Is Tasker Action: true</com.twofortyfouram.locale.intent.extra.BLURB>
					<com.twofortyfouram.locale.intent.extra.BLURB-type>java.lang.String</com.twofortyfouram.locale.intent.extra.BLURB-type>
					<net.dinglisch.android.tasker.RELEVANT_VARIABLES>&lt;StringArray sr=""&gt;&lt;_array_net.dinglisch.android.tasker.RELEVANT_VARIABLES0&gt;%err
...
Only available if you select &amp;lt;b&amp;gt;Continue Task After Error&amp;lt;/b&amp;gt; and the action ends in error&lt;/_array_net.dinglisch.android.tasker.RELEVANT_VARIABLES1&gt;&lt;/StringArray&gt;</net.dinglisch.android.tasker.RELEVANT_VARIABLES>
	...
	<Task sr="task74">
		...
		<edate>1579552027335</edate>
		<id>74</id>
		<nme>Backup.Nova._clickBack</nme>
		<pri>100</pri>
		<Action sr="act0" ve="7">
...
Only available if you select &amp;lt;b&amp;gt;Continue Task After Error&amp;lt;/b&amp;gt; and the action ends in error&lt;/_array_net.dinglisch.android.tasker.RELEVANT_VARIABLES1&gt;&lt;/StringArray&gt;</net.dinglisch.android.tasker.RELEVANT_VARIABLES>
	...
	<Task sr="task75">
		...
		<edate>1579552040573</edate>
		<id>75</id>
		<nme>Backup.Nova._launchSettingsOnFirstPage</nme>
		<pri>100</pri>
		<Action sr="act0" ve="7">
			<code>20</code>
			<App sr="arg0">
...
Only available if you select &amp;lt;b&amp;gt;Continue Task After Error&amp;lt;/b&amp;gt; and the action ends in error&lt;/_array_net.dinglisch.android.tasker.RELEVANT_VARIABLES7&gt;&lt;/StringArray&gt;</net.dinglisch.android.tasker.RELEVANT_VARIABLES>
		...
		<Action sr="act4" ve="7">
			<code>130</code>
			<Str sr="arg0" ve="3">Backup.Nova._clickBack</Str>
			<Int sr="arg1">
				<var>%priority</var>
			</Int>
			<Str sr="arg2" ve="3"/>
	...
	<Task sr="task76">
		<cdate>1579546067927</cdate>
		<edate>1579959913428</edate>
		<id>76</id>
		<nme>Backup.runAll</nme>
		<pri>7</pri>
		<Action sr="act0" ve="7">
			<code>130</code>
			<Str sr="arg0" ve="3">Backup.GoogleAccount.run</Str>
			<Int sr="arg1">
				<var>%priority</var>
			</Int>
			<Str sr="arg2" ve="3"/>
		...
		<Action sr="act2" ve="7">
			<code>130</code>
			<Str sr="arg0" ve="3">Backup.Settings.run</Str>
			<Int sr="arg1">
				<var>%priority</var>
			</Int>
			<Str sr="arg2" ve="3"/>
		...
		<Action sr="act4" ve="7">
			<code>130</code>
			<Str sr="arg0" ve="3">Backup.Nova.run</Str>
			<Int sr="arg1">
				<var>%priority</var>
			</Int>
			<Str sr="arg2" ve="3"/>
